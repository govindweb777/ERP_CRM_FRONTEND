  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2 style={{ fontSize: 20, fontWeight: 700, color: '#222' }}>Create New Lead</h2>
          <button
            onClick={onClose}
            style={{
              padding: 6,
        ...
        <div style={{ padding: 16 }}>
          {formError && (
            ...
            >
              <span style={{ color: '#b91c1c', fontSize: 14 }}>{formError}</span>
            </div>
          )}
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16 }}>
            ...
            <div style={{ flex: '1 1 220px', minWidth: 200 }}>
              ...
              {userLoading && <p style={{ fontSize: 12, color: '#6b7280', marginTop: 4 }}>Loading users...</p>}
            </div>
            <div style={{ flex: '1 1 220px', minWidth: 200 }}>
              <label style={{ display: 'block', fontSize: 13, fontWeight: 500, color: '#444', marginBottom: 6 }}>
                Status
          ...
          <div style={{ marginBottom: 16 }}>
            <h3 style={{ fontSize: 16, fontWeight: 500, color: '#222', marginBottom: 8 }}>Address Information</h3>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              ...
              style={{ width: '100%', padding: 8, border: '1px solid #d1d5db', borderRadius: 6, fontSize: 14 }}
            />
            <p style={{ fontSize: 12, color: '#6b7280', marginTop: 4 }}>Upload PDF, DOC, or image files (Required)</p>
          </div>
